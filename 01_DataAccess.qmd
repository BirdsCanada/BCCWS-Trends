...
BCCWS<-nc_data_dl(collection="BCCWS", username = "rdjmacklin", fields_set = "core", request_id = 258865) #you will be prometed for your password
...
guilds<-read_delim("Data/GuildList.csv", delim = ";")
