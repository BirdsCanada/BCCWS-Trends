## Set up output tables
  ...
  write.table(indices.csv,
              file = file.path(out.dir, paste0 ("BCCWS_AnnualIndices.csv")),
  ...
  #             file = file.path(out.dir, paste0("BCCWS_TrendsEndpoint.csv")),
  #             row.names = FALSE, append = FALSE, quote = FALSE, sep = ",")
  

  write.table(trends.csv,
              file = file.path(out.dir, paste0("BCCWS_TrendsSlope.csv")),
              row.names = FALSE, append = FALSE, quote = FALSE, sep = ",")
  ...
  write.table(dispersion.csv,
              file = file.path(out.dir, paste0("BCCWS_DispersionStat.csv")),
              row.names = FALSE, append = FALSE, quote = FALSE, sep = ",")
  
  message("Output tables created for model BCCWS iCAR Model")
